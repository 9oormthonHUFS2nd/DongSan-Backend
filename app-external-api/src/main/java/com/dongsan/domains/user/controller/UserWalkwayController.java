...
public class UserWalkwayController {
    ...
    public ResponseEntity<SuccessResponse<WalkwayListResponse>> getUserUploadWalkway(
        ...
        List<Walkway> walkways = userWalkwayUseCase.getUserUploadWalkway(customOAuth2User.getMemberId(), size, walkwayId);
        return ResponseFactory.ok(new WalkwayListResponse(walkways));
    }
    ...
    public ResponseEntity<SuccessResponse<WalkwayListResponse>> getUserLikedWalkway(
        ...
        List<Walkway> walkways = userWalkwayUseCase.getUserLikedWalkway(customOAuth2User.getMemberId(), size, walkwayId);
        return ResponseFactory.ok(new WalkwayListResponse(walkways));
    }
