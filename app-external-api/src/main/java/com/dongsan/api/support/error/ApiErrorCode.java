...
public enum ApiErrorCode {
    ...
    TERMS_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH-06", "약관 동의 토큰의 유효기간이 만료되었습니다."),
    ...
    REFRESH_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH-10", "쿠키에 리프레시 토큰이 없습니다."),
    ACCESS_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH-11", "요청 헤더에 엑세스 토큰이 없습니다."),
    ;
