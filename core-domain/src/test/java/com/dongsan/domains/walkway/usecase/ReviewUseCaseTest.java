...
class ReviewUseCaseTest {
    ...
    class Describe_createReview {
        ...
        void it_returns_responseDTO() {
            ...
            // When
            CreateReviewResponse result = reviewUseCase.createReview(memberId, walkwayId, createReviewRequest);
    ...
    class Describe_getWalkwayReviews {
        ...
        void it_returns_review_list_rating() {
            ...
            // When
            GetWalkwayReviewsResponse result = reviewUseCase.getWalkwayReviews(type, null, walkwayId, size, member.getId());
        ...
        void it_returns_exception() {
            ...
            // When & Then
            assertThatThrownBy(() -> reviewUseCase.getWalkwayReviews(type, null, walkwayId, size, member.getId()))
    ...
    class Describe_getWalkwayRating {
        ...
        void it_returns_walkway_rating_info() {
            ...
            // When
            GetWalkwayRatingResponse result = reviewUseCase.getWalkwayRating(walkway.getId(), member.getId());
