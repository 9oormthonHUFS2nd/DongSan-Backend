...
//
//            // When
//            List<Bookmark> result = bookmarkReader.getUserBookmarks(lastBookmark, memberId, limit);
//
//            // Then
...
//
//            // When
//            List<Bookmark> result = bookmarkReader.getUserBookmarks(null, memberId, limit);
//
//            // Then
...
//
//            // When
//            List<BookmarksWithMarkedWalkwayDTO> result = bookmarkReader.getBookmarksWithMarkedWalkway(walkwayId, memberId, lastBookmark, 5);
//
//            // Then
