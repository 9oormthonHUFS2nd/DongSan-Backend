package com.dongsan.core.domains.walkway.service.search.review;
...
public class GetLatestReviewsService implements GetReviewsService {
    ...
    public List<Review> search(Integer size, Review review, Walkway walkway) {
        return reviewQueryDSLRepository.getWalkwayReviewsLatest(size, walkway.getId(), review);
    }
}
